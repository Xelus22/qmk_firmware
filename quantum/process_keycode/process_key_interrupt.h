...
#ifndef NUM_KEY_INTERRUPTS
#error "NUM_KEY_INTERRUPTS must be defined in your config.h"
#endif

#define NUM_INTERRUPT_KEYCODES 2

extern const uint16_t key_interrupt_list[NUM_KEY_INTERRUPTS][NUM_INTERRUPT_KEYCODES];
